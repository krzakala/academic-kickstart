...
Florent Krzakala is a professor at [Sorbonne Université](http://www.sorbonne-universite.fr/en) and a Researcher at [Ecole Normale Superieure](https://www.ens.fr/en) in Paris. His research interests include Statistical Physics, Machine Learning, Probability, Statistics, Computer Science and Computational Optics. He leads the SPHINX “Statistical PHysics of INformation eXtraction” team in Ecole Normale in Paris, and is the holder of the [CFM-ENS Datascience chair](https://data-ens.github.io/). He is also the funder and scientific advisor of the startup [Lighton](http://www.lighton.ai).
